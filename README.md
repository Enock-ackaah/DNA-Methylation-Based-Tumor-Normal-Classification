...
The GEO series matrix file was loaded locally using the GEOquery package. DNA methylation levels were extracted as beta values ranging from 0 to 1, where higher values indicate greater methylation.

**Preprocessing steps included**:
Removal of non-CpG probes by retaining probes with identifiers beginning with "cg"
Enforcement of numeric data types
Validation of matrix dimensions and beta value ranges
